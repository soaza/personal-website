      ...
      <>
        ...
        <div className="text-white flex flex-col gap-2 h-full">
          ...
          <div className="text-2xl font-thin 2xl:text-2xl text-orange-300">
            {data?.recentlyPlayedTrack.track.artists[0].name}
          </div>
          ...
          <a
            className="absolute bottom-2 right-1 kist flex flex-row align-middle items-center gap-2"
            href={data?.recentlyPlayedTrack.track.uri}
          >
            <span className="text-md font-light">RECENTLY PLAYED</span>
